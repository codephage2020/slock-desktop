...
<p align="center">
  <a href="https://github.com/codephage2020/slock-desktop/releases/tag/v0.2.5"><img alt="Version / 版本 0.2.5" src="https://img.shields.io/badge/Version%20%2F%20%E7%89%88%E6%9C%AC-0.2.5-10A37F?style=flat-square&logo=github"></a>
...
| 安装依赖 | `pnpm install` |
| 桌面开发 | `pnpm tauri:dev` |
| 构建并打开当前 debug app 包 | `pnpm tauri:debug:open` |
| 前端开发 | `pnpm dev` |
| 项目检查 | `pnpm test` |
